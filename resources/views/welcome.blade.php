                ...
                <div class="events-grid" id="carousel-terdekat">
                    ...
                    <div onclick="location.href='{{ url('/order/' . $event->id) }}'" class="event-card">
                        ...
                        <div class="event-card-body">
                            ...
                            <div class="event-date">{{ $event->event_datetime?->format('d M Y') }}</div>
                    ...
                    <div class="event-card">
                        <div class="event-card-body">
                            <div class="event-name">Belum ada event aktif</div>
                            <div class="event-date">Data event akan tampil dari database.</div>
                        </div>
                    </div>
                    @endforelse
                </div>
