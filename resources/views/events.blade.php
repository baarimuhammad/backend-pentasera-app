...
<div class="batik-bg min-h-screen">
    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="flex-1">
            @php
                $allEvents = [
                    ['id'=>1,'name'=>'Witness the Fire of Uluwatu','img'=>'kecak.png','date'=>'03 Apr 2026','dataDate'=>'2026-04-03','venue'=>'Pura Luhur Uluwatu, Bali','price'=>'Rp150.000','kategori'=>'Tari'],
                    ['id'=>2,'name'=>'Stories Carved in Tradition','img'=>'wayang.png','date'=>'08 Apr 2026','dataDate'=>'2026-04-08','venue'=>'Keraton Yogyakarta','price'=>'Rp50.000','kategori'=>'Wayang'],
                    ['id'=>3,'name'=>'Feel the Rhythm of Minangkabau','img'=>'taripiring.png','date'=>'11 Apr 2026','dataDate'=>'2026-04-11','venue'=>'Padang Cultural Center','price'=>'Rp80.000','kategori'=>'Tari'],
                    ['id'=>4,'name'=>'Harmony of Javanese Heritage','img'=>'gamelan.png','date'=>'12 Apr 2026','dataDate'=>'2026-04-12','venue'=>'Jatim Expo Surabaya','price'=>'Rp100.000','kategori'=>'Musik'],
                    ['id'=>5,'name'=>'Experience the Magic of Bali','img'=>'TariBarong.png','date'=>'15 Apr 2026','dataDate'=>'2026-04-15','venue'=>'GWK Cultural Park, Bali','price'=>'Rp125.000','kategori'=>'Tari'],
                    ['id'=>6,'name'=>'Rhythm in Perfect Harmony','img'=>'tarisaman.png','date'=>'20 Apr 2026','dataDate'=>'2026-04-20','venue'=>'Istora Senayan, Jakarta','price'=>'Rp200.000','kategori'=>'Tari'],
                    ['id'=>7,'name'=>'Grace in Every Movement','img'=>'jaipong.png','date'=>'25 Apr 2026','dataDate'=>'2026-04-25','venue'=>'Saung Angklung Udjo, Bandung','price'=>'Rp75.000','kategori'=>'Tari'],
                    ['id'=>8,'name'=>'The Spirit of Batak Heritage','img'=>'tortor.png','date'=>'30 Apr 2026','dataDate'=>'2026-04-30','venue'=>'Danau Toba, Sumatera Utara','price'=>'Rp50.000','kategori'=>'Tari'],
                    ['id'=>9,'name'=>'Elegance of the Royal Court','img'=>'legong.png','date'=>'05 Mei 2026','dataDate'=>'2026-05-05','venue'=>'Puri Saren Agung, Ubud','price'=>'Rp120.000','kategori'=>'Tari'],
                    ['id'=>10,'name'=>'Stories Carved in Tradition II','img'=>'wayanggolek.png','date'=>'10 Mei 2026','dataDate'=>'2026-05-10','venue'=>'Gedung Kesenian Jakarta','price'=>'Rp90.000','kategori'=>'Wayang'],
                ];
            @endphp
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" id="events-container">
                @foreach($allEvents as $ev)
                <div onclick="location.href='{{ url('/order/'.$ev['id']) }}'" data-date="{{ $ev['dataDate'] }}" data-kategori="{{ $ev['kategori'] }}" data-venue="{{ strtolower($ev['venue']) }}" class="event-item bg-white rounded-xl overflow-hidden shadow-md hover-lift transition-all cursor-pointer border border-gold/10 group">
                    <div class="relative h-48 overflow-hidden">
                        <img src="{{ asset('assets/'.$ev['img']) }}" alt="{{ $ev['name'] }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    </div>
                    <div class="p-5">
                        <h3 class="font-display font-bold text-base text-ink mb-3 line-clamp-1 group-hover:text-rust transition-colors">{{ $ev['name'] }}</h3>
                        <div class="space-y-2 mb-4">
                            <div class="flex items-center gap-2 text-xs text-gray-500">
                                <i data-lucide="calendar" class="w-3.5 h-3.5 text-rust"></i> {{ $ev['date'] }}
                            </div>
                            <div class="flex items-center gap-2 text-xs text-gray-400">
                                <i data-lucide="map-pin" class="w-3.5 h-3.5 text-gold"></i> {{ $ev['venue'] }}
                            </div>
                        </div>
                        <div class="flex items-center justify-between pt-4 border-t border-gold/10">
                            <div class="font-bold text-rust-deep text-lg">{{ $ev['price'] }}</div>
